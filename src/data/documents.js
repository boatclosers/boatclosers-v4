...
<div class="notary">
  ...
  // the lender, insurer, and surveyor issue.
  {
    ...
    // An information sheet, not an agreement — there is nothing on it to sign, so
    // offering E-Sign produced a signature with no signature line to land on.
    viewOnly: true,
...
// The deposit paragraph of the Purchase Agreement: where the money sits, who
// holds it, and what happens to it. This was referenced as {{DEPOSIT_TERMS}} but
// never built, so every agreement was generated without it.
