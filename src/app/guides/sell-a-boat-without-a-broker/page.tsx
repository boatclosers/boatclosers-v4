    ...
    <div style={{ background: navy, minHeight: '100vh', color: cream }}>
      ...
      >
        ...
        <p>
          ...
          half. The fastest filter is a written offer with a deposit attached — people
          who are not serious will not put money behind a number.
        </p>
        <p>
        ...
        <p>
          ...
          next — whether the buyer may withdraw, request a price adjustment, or ask
          for repairs before closing. When that path is written down in advance, the
