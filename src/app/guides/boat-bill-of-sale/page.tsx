    ...
    <div style={{ background: navy, minHeight: '100vh', color: cream }}>
      ...
      >
        ...
        <p>
          ...
          of sale matters more than people expect — it establishes when liability,
          insurance responsibility, and the tax obligation transferred.
        </p>
        <p>
          ...
          undermines the document's credibility if the sale is ever disputed.
        </p>
